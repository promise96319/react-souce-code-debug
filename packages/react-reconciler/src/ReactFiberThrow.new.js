...
function throwException(
  ...
  if (
    ...
    // 处理 suspense
    // 找到父亲 suspense ，然后在fiber.updateQueue上增加 wakeable
    do {
      if (
    ...
    value = new Error(
      (getComponentNameFromFiber(sourceFiber) || 'A a component') +
  ...
  // workInProgress 为报错的具体组件
  value = createCapturedValue(value, sourceFiber);
  let workInProgress = returnFiber;
  do {
    switch (workInProgress.tag) {
      // 如果为 hostRoot，添加了 capture update
      case HostRoot: {

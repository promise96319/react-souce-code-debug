...
export function createContainer(
  containerInfo: Container, // 容器信息
  tag: RootTag, // 模式 legacy / concurrent
  hydrate: boolean,
  hydrationCallbacks: null | SuspenseHydrationCallbacks,
  isStrictMode: boolean,
  concurrentUpdatesByDefaultOverride: null | boolean,
): OpaqueRoot {
  // 创建了根节点及相应的 fiber，并建立了两者的关系
  // fiber 上初始化了更新队列 updateQueue
...
export function updateContainer(
  ...
  // 返回 对应的 lane
  // 第一次进来，concurrentMode，返回的lane 为 DefaultLane
